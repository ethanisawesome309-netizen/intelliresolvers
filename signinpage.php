<?php
// ==================================================
// CANONICAL HOST (PREVENT CSRF SESSION SPLIT)
// ==================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        Your session expired or became invalid.<br><br>
...
.navbar__links:hover { color: #f77062; }
...
.signin-card p { color: #ccc; margin-bottom: 2rem; }
...
input:focus { outline: 2px solid #f77062; }
...
.footer__link--items h3 { color: #f77062; margin-bottom: 1rem; }
.footer__link--items a { color: #fff; text-decoration: none; display: block; margin-bottom: 0.5rem; }
.footer__link--items a:hover { color: #f77062; }

.website__rights { color: #777; font-size: 0.8rem; }
</style>
</head>
