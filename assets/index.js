import{r,j as e,c as k,R as j}from"./client.js";function w(){const[s,o]=r.useState([]),[n,d]=r.useState(""),[c,l]=r.useState(""),[m,u]=r.useState(!1),[f,i]=r.useState(""),[p,g]=r.useState("");r.useEffect(()=>{b()},[]);async function b(){try{const t=await fetch("/api/list_tickets.php",{credentials:"same-origin"});if(t.status===401){o([]),i("");return}if(!t.ok)throw new Error;const a=await t.json();o(a),i("")}catch{i("Could not load tickets.")}}async function h(t){t.preventDefault(),u(!0),g("");try{const a=await fetch("/api/create_ticket.php",{method:"POST",headers:{"Content-Type":"application/json"},credentials:"same-origin",body:JSON.stringify({title:n,message:c})}),x=await a.json();if(!a.ok)throw new Error(x.error||"Submission failed");d(""),l(""),await b()}catch(a){g(a.message)}finally{u(!1)}}return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        * {
